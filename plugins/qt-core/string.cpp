...
static void register_string__section_flag(script::Class& parent)
{
  ...
  Enum section_flag = gonk::bind::enumeration<QString::SectionFlag>(parent, "SectionFlag").get();
...
static void register_string__split_behavior(script::Class& parent)
{
  ...
  Enum split_behavior = gonk::bind::enumeration<QString::SplitBehavior>(parent, "SplitBehavior").get();
...
static void register_string__normalization_form(script::Class& parent)
{
  ...
  Enum normalization_form = gonk::bind::enumeration<QString::NormalizationForm>(parent, "NormalizationForm").get();
