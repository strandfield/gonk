...
static void register_char__special_character(script::Class& parent)
{
  ...
  Enum special_character = parent.newEnum("SpecialCharacter").setId(script::Type::make<QChar::SpecialCharacter>().data()).get();
...
static void register_char__category(script::Class& parent)
{
  ...
  Enum category = parent.newEnum("Category").setId(script::Type::make<QChar::Category>().data()).get();
...
static void register_char__script(script::Class& parent)
{
  ...
  Enum script = parent.newEnum("Script").setId(script::Type::make<QChar::Script>().data()).get();
...
static void register_char__direction(script::Class& parent)
{
  ...
  Enum direction = parent.newEnum("Direction").setId(script::Type::make<QChar::Direction>().data()).get();
...
static void register_char__decomposition(script::Class& parent)
{
  ...
  Enum decomposition = parent.newEnum("Decomposition").setId(script::Type::make<QChar::Decomposition>().data()).get();
...
static void register_char__joining_type(script::Class& parent)
{
  ...
  Enum joining_type = parent.newEnum("JoiningType").setId(script::Type::make<QChar::JoiningType>().data()).get();
...
static void register_char__joining(script::Class& parent)
{
  ...
  Enum joining = parent.newEnum("Joining").setId(script::Type::make<QChar::Joining>().data()).get();
...
static void register_char__combining_class(script::Class& parent)
{
  ...
  Enum combining_class = parent.newEnum("CombiningClass").setId(script::Type::make<QChar::CombiningClass>().data()).get();
...
static void register_char__unicode_version(script::Class& parent)
{
  ...
  Enum unicode_version = parent.newEnum("UnicodeVersion").setId(script::Type::make<QChar::UnicodeVersion>().data()).get();
